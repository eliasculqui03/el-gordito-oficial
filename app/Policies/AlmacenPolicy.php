...
class AlmacenPolicy
{
    ...
    {
        return $user->can('delete_any_almacen');
    }
    ...
    {
        return $user->can('force_delete_any_almacen');
    }
    ...
    {
        return $user->can('restore_any_almacen');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Almacen $almacen): bool
    {
        return $user->can('replicate_almacen');
    }
    ...
    {
        return $user->can('reorder_almacen');
    }
}
