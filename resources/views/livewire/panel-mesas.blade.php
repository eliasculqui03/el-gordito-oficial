<div class="min-h-screen m-2 border border-gray-200 bg-gray-50 dark:bg-gray-900 dark:border-gray-700 rounded-2xl">
    ...
    @if ($mostrarNotificacion)
        <div wire:key="notification-{{ $tiempoNotificacion }}"
            class="fixed top-4 right-4 z-50 px-4 py-3 rounded-lg shadow-lg {{ $notificacion['tipo'] === 'success' ? 'bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100' : 'bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-100' }}">
