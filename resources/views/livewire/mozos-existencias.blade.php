                        ...
                        <div class="p-6">
                            ...
                            @else
                                <div class="py-12 text-center">
                                    ...
                                    <h3 class="mt-2 text-lg font-medium text-gray-900">No hay existencias listas</h3>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="p-6">
                            ...
                            @else
                                <div class="py-12 text-center">
                                    ...
                                    <h3 class="mt-2 text-lg font-medium text-gray-900">No tienes existencias asignadas
                                    </h3>
                                </div>
                            @endif
                        </div>
