<div>
    ...
    @if ($isOpen)
        <div wire:poll.5s.visible
            class="fixed inset-0 z-50 flex items-center justify-center p-2 overflow-y-auto sm:p-4 bg-gray-950/50 dark:bg-gray-950/75"
            ...
            <div class="relative w-full max-w-4xl mx-auto bg-white shadow-lg rounded-xl dark:bg-gray-800 dark:ring-1 dark:ring-white/10
                ...
                @click.outside="$wire.closeModalMesa()">
                <!-- Cabecera del Modal -->
                <div
                ...
                <div class="flex-1 p-3 overflow-y-auto sm:p-4">
                    <!-- Zonas -->
            ...
            {{ $mesa->estado === 'Libre'
                ...
                : ($mesa->estado === 'Ocupada'
                    ...
                    : 'text-gray-700 dark:text-gray-400') }}">
                        ...
                        @else
                            <div
                                class="flex items-center justify-center h-24 text-gray-500 rounded-lg sm:h-32 dark:text-gray-400 bg-gray-50 dark:bg-gray-700/30">
                                <div class="flex flex-col items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-6 h-6 mb-2 sm:w-8 sm:h-8 opacity-60" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                ...
                <!-- Footer fijo -->
                <div
                    class="sticky bottom-0 z-10 flex justify-end p-3 bg-white border-t sm:p-4 dark:border-gray-700 dark:bg-gray-800 rounded-b-xl">
                    <button wire:click="closeModalMesa"
