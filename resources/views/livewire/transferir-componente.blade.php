<div>
    <button type="button" wire:click="openModal"
        class="flex flex-col items-center justify-center w-full px-2 py-3 text-sm font-medium text-white transition rounded-md bg-amber-500 hover:bg-amber-600 dark:bg-amber-600 dark:hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-amber-500 dark:focus:ring-amber-400">
        ...
        <span class="text-xs sm:text-sm">Transferir</span>
    </button>
                ...
                <div class="p-4 mb-5 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                    ...
                    <div class="flex items-center justify-between mb-2">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Caja Origen:</span>
                        </div>
                        <span
                            class="text-sm font-semibold text-gray-900 dark:text-white">{{ $cajaOrigen->nombre ?? 'N/A' }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-semibold text-green-600 dark:text-green-400">S/.
                            {{ number_format($cajaOrigen->saldo_actual ?? 0, 2) }}</span>
                    </div>
                </div>
